...
const tld = '.gogo';
const CONTRACT_ADDRESS = '0xA7b09689171F7D4363329f4aB88eB915eF75b388';
...
const App = () => {
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      <img src="https://media.giphy.com/media/kiBcwEXegBTACmVOnE/giphy-downsized-large.gif" alt="Dog gif" />
		...
		return (
			<div className="form-container">
				...
				<input
					type="text"
					value={record}
					placeholder='whats ur power from'
